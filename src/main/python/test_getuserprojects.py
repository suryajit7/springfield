...
def url():
	# GET API
	return "https://stagingapi.demo.com/v1/demo/users/projects"


data = [
	('suryajit7@gmail.com', '111111'),   # user which has projects assigned
...
def get_accesstoken(email, password):
	auth_url = 'https://stagingapi.demo.com/v1/auth'
