package works.springfield.framework.page;

import lombok.Getter;
import org.openqa.selenium.*;
import org.openqa.selenium.support.ui.ExpectedCondition;
import org.openqa.selenium.support.ui.Select;
import works.springfield.framework.core.Kernel;
import works.springfield.framework.core.annotation.Page;

import java.util.List;

import static org.openqa.selenium.support.ui.ExpectedConditions.*;
import static works.springfield.framework.data.Constants.BLANK;

@Page
@Getter
public class BasePage extends Kernel {

    protected final List<Class<? extends WebDriverException>> exceptionList = List.of(NoSuchWindowException.class, NoSuchFrameException.class,
            NoAlertPresentException.class, InvalidSelectorException.class, TimeoutException.class, NoSuchSessionException.class, StaleElementReferenceException.class);
